  ...
  <jsp:include page="HeaderLayout.jsp" />
      ...
      <div class="row" style="overflow: auto;">
        <div class="box" style="height: auto;">
          <div class="row" style="border:1px solid; position: relative;border-radius:25px; width: 50%; margin: 0 0 0 -200px; left: 44%;"  > 
          <div class="col-lg-12">
            <hr>
            ...
            <hr>
              ...
              Problem with registration! Kindly try again !!
            </div> 
