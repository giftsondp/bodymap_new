...
<script type="text/javascript">
    ...
    <div class="container" style="height: 100%">
      ...
      <div class="row" style="height: 710px">
        <div class="box" style="height: 100%">
          <div class="row" style="border:1px solid; position: absolute;border-radius:25px; width: 30%;  left: 38%;"  > 
          <div class="col-lg-12">
            <hr>
 ...
 <div class="clearfix"></div>
                ...
                <div class="alert alert-danger alert-dismissable" id="errorDiv" style="visibility: hidden; width: 100%">
              <button type="button" class="close" data-dismiss="alert" id="error" aria-hidden="true">&times;</button>
